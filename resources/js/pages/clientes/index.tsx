...
export default function Index() {
    ...
    const handleFilter = () => {
        router.get(route("clientes.index"), { search }, { preserveState: true, replace: true });
    };
                ...
                <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-4 md:p-6">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-4">
                        ...
                        <div className="flex flex-wrap gap-2 md:gap-4 items-center">
                            ...
                            <button
                                onClick={() => router.get("/clientes/create")}
                    ...
                    <table className="w-full border border-gray-300 shadow-md rounded-lg overflow-hidden">
                        <thead className="bg-gray-200 text-gray-700">
                            <tr>
                                <th className="p-3 text-left text-sm font-semibold border-b">DNI</th>
                            ...
                            {clientes.data.map((cliente) => (
                                <tr key={cliente.id} className="hover:bg-gray-50 transition">
                                    ...
                                    <td className="p-3 text-sm flex gap-2">
                                        <button
                                            onClick={() => router.get(`/clientes/${cliente.id}/edit`)}
